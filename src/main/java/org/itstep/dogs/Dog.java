...
public class Dog extends Animal {
    public static final String type="Собака";

    public Dog(String name, LocalDate birthday, int weight, int aviary, LocalDate arrival, int money_per_day, int money_all_time, String sex) {
